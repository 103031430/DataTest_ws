...
: ${AMENT_CURRENT_PREFIX:="/root/DataTest_ws/install/LargeData"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/LargeData/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/LargeData/environment/path.sh"
